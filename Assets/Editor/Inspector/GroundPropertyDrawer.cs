...
[CustomPropertyDrawer(typeof(Ground))]
public class GroundPropertyDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		EditorGUI.LabelField(r2, "Type", ground.Type.ToString());
		EditorGUI.LabelField(r3, "Option", ground.Option.ToString());
	}

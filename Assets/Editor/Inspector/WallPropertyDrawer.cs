...
public class WallPropertyDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		EditorGUI.LabelField(r2, "Type", wall.Type.ToString());
		EditorGUI.LabelField(r3, "Option", wall.Option.ToString());
	}
